...
extension UIColor {
    ...
    struct AppColor {
        ...
        static let primaryDark = UIColor.init(named: "PrimaryDark") ?? UIColor.init(netHex: 0x02343B)
        static let primarySemiDark = UIColor.init(named: "PrimarySemiDark") ?? UIColor.init(netHex: 0x027E8B)
