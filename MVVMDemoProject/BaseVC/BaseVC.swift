...
class BaseVC: UIViewController {
    ...
    func changeNavigationBar(withMenu: Bool = false) {
        ...
        self.navigationController?.navigationBar.barTintColor = UIColor.AppColor.bgColor
...
//        let backImage = UIImage(named: "Back")?.withInsets(UIEdgeInsets(top: 0, left: 20, bottom: 0, right: 0))?.withRenderingMode(.alwaysOriginal)
//
...
//    }
    ...
    func showNoDataMsg(message: String, inCenter:Bool = true) {
      //  lbl.font = UIFont.init(name: UIFont.AppFont.medium, size: 18)
       // lbl.fontStyle = UIFont.AppFont.medium
        lbl.fontSize = "18"
    ...
    @objc private func btnDotsPressed(){
