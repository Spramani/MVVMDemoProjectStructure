...
class Utils: NSObject {
    ...
    class func openLoginInvitePopup(in controller:UIViewController){
        ...
        let okAction = UIAlertAction(title: "Login".localizedString, style: UIAlertAction.Style.default) {
            UIAlertAction in
//            let vc = SignInVC()
//            let nvc =  NavVC.init(rootViewController: vc)
...
//           return String.init(format: "Ver %@.%@", Utils.versionString(),Utils.buildNumber())
//       }
...
//    class func drawDottedLine(start p0: CGPoint, end p1: CGPoint, mid m:CGPoint, view: UIView) {
//        Utils.removeLayerWithName(name: "Progress", fromView: view)
//        let shapeLayer = CAShapeLayer()
//        shapeLayer.strokeColor = UIColor.AppColor.textStroke.cgColor
//        shapeLayer.fillColor = UIColor.clear.cgColor
//        shapeLayer.lineWidth = 3
//        shapeLayer.name = "Progress"
//        shapeLayer.lineDashPattern = [28, 28] // 7 is the length of dash, 3 is length of the gap.
//        shapeLayer.lineCap = .round
//        
//        let path = UIBezierPath()//quadCurvedPath(withPoints: [p0, CGPoint(x: self.bounds.size.width*0.75, y: self.center.y), p1])
//        path.move(to: p0)
//        path.addQuadCurve(to: p1, controlPoint:m)
...
//    class func dataFromUrl(info: [UIImagePickerController.InfoKey : Any])
//    {
//        if let referenceURL = info[.mediaURL] as? URL {
